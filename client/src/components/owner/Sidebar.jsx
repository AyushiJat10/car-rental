    ...
    max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
        ...
        <div className='group relative'>
            <label htmlFor="image">
                ...
                <input type="file"  id="image" accept='image/*' hidden onChange={e=> setImage(
                    e.target.files[0]
                )} />

                <div className='absolute hidden top-0 right-0 left-0 bottom-0 bg-black\10
                rounded-full group-hover:flex items-center
        ...
        {image && (
            ...
            text-primary cursor-pointer '>Save <img src={assets.check_icon} alt="" width={13} onClick={updateImage}/></button>
        )}
