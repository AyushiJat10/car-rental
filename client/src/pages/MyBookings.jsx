...
const MyBookings = () => {
  ...
  return (
    ...
    max-w-7xl'>
      ...
      subTitle='View and manage your all car bookiongs'
      align="left"/>

      <div>
        {bookings.map((bookings, index)=>(
          <div key={bookings._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6
              ...
              <p className='text-gray-500'>{bookings.car.year} . {bookings.car.category} . {bookings.car.location}</p>
                ...
                <div className='md:col-span-2'>
                  <div className='flex items-center gap-2'>
                    ...
                    <p className={`px-3 py-1 text-xs rounded-full ${bookings.status ===
