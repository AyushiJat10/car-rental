...
const deleteCar = async (carId)=>{
    try {
      const confirm = window.confirm('Are you sure you want to delete thi car?')
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
       <Title title="Manage cars " subTitle="View all listed cars, update their details, or rmove them from the booking platform." /> 
